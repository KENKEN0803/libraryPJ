...
<div id="subheader" style="height:80px; margin-left:13%; margin-right:13%; margin-bottom:1%; border-radius:20px; box-shadow:gray 0px 5px 3px 0px">
	<div class="row">
				 <form action="/searchResult" method="get" style="margin-left:8%">
				    ...
				    <input type="text" name="inputValue" placeholder="책 이름을 입력해주세요." style="width:70%; border-radius:5px; float:left; margin-left:1%;"></input>
				    <button type="submit" style="width:10%; height:32px; border-radius:8px; border:none; background: #EDFFED; margin-left:1%;" >검색</button>
				</form>
	</div>
</div>
<!-- =========================ANIMATED COLUMNS =============================== -->
