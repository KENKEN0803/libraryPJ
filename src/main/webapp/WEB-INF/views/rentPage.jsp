...
<h1>대출</h1>
	<div style="display: block; width: 300px; margin-left: 31%; margin-top: 4%;">
		<form action="rentPage" method="get">
			...
			<input type="text" name="b_id" value="" style="width: 150px; background-color: #eeeeee; height: 24px; float: left;">
...
<form action="subRentPage" method="post">
	...
	<input type="submit" value="대출 승인" class="subbtn" style="border-radius: 20px; margin-left: 14%">
</form>
