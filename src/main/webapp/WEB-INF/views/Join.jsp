		...
		<div id="jform">
			<fieldset>
				<form method=POST action="join_success" name="regForm">
					...
					<label>이름</label><input type="text" id="mem_name" name="mem_name" onchange="nameCheck(this)" required><Br>
					<label>주민등록번호</label><input type="text" name="mem_reg" required pattern=".{13,13}" title="주민등록번호 13자리를 정확하게 입력하세요." maxlength="13" oninput="numCheck(this)"><Br>
					<label>핸드폰번호</label><input type="text" name="mem_tel" required pattern=".{11,11}" title="전화 번호 11자리를 숫자만 입력하세요." maxlength="11" oninput="numCheck(this)"><Br>
					<input type="submit" value="가입" style="float:center;"> <button>
